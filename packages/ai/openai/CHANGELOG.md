...
- [#8236](https://github.com/Effect-TS/effect/pull/8236) [`90695b0`](https://github.com/Effect-TS/effect/commit/90695b0d5bee3aa33e67cbea1aa2e6298816a64f) Thanks @danieljvdm! - Support API sources in OpenAI web search. Narrow sources by `type` before reading `url` or `name`.
...
- [#8157](https://github.com/Effect-TS/effect/pull/8157) [`fdec3b2`](https://github.com/Effect-TS/effect/commit/fdec3b23a163566b65ce67b721b4d2faa009001c) Thanks @danieljvdm! - Report failed OpenAI provider-executed tool calls as failure tool results in both `generateText` and `streamText`, preserving the call details.
