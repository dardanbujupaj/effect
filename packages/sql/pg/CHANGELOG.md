...
- [#8174](https://github.com/Effect-TS/effect/pull/8174) [`91abe38`](https://github.com/Effect-TS/effect/commit/91abe38c3797b1c290aedef3b01e8c96dd4fee79) Thanks @tim-smart! - Default TLS servername to the hostname for non-IP hosts during connection startup and cancellation, restoring connections to Postgres endpoints that require SNI. Preserve explicit SSL servername overrides.
